...
<script src="{{ asset('style') }}/assets/plugins/peity-chart/jquery.peity.min.js"></script>

<!--Morris Chart-->
<script src="{{ asset('style') }}/assets/plugins/morris/morris.min.js"></script>
<script src="{{ asset('style') }}/assets/plugins/raphael/raphael-min.js"></script>

<script src="{{ asset('style') }}/assets/pages/dashboard.js"></script>
